        ...
        {!done ? (
          <>
            ...
            <p className="mt-3 text-sm md:text-[15px] text-white/70 leading-relaxed">
              Every one of our <span className="text-white font-medium">800+ source-linked scholarships</span> — sorted by deadline. Printable. Share-worthy. Yours in 10 seconds.
            </p>
