...
export function tipsEmail({ name, unsubscribeUrl }) {
  const inner = `
    ...
    <p style="margin:20px 0 6px;color:#F0D77A;font-weight:600;">1. Nova AI research assistant</p>
...
export function founderEmail({ name, unsubscribeUrl }) {
  const inner = `
    ...
    <p style="margin:16px 0;">Today: 800 hand-verified scholarships, all source-linked to the official provider. No dead links. No aggregator middlemen. And AI-assisted research + essay writing that would cost you $500+ from a consultant.</p>
