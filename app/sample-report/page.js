    ...
    <div className="cosmos-bg min-h-screen">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto max-w-6xl px-4 py-10 relative">
          ...
          <p className="mt-2 text-slate-400 max-w-3xl">A preview of the AI report ScholarshipFit generates — grounded in real, source-linked records. This is an illustrative sample built from a fictional student profile.</p>

          <Card className="mt-6 border-white/10 bg-gradient-to-br from-cyan-500/10 to-white/[0.02]">
            <CardContent className="p-5">
              <p className="text-[11px] uppercase tracking-widest text-cyan-300">Student profile summary</p>
              <div className="mt-3 grid gap-3 sm:grid-cols-2 md:grid-cols-4 text-sm text-slate-200">
              ...
              {meta && (<p className="mt-4 text-sm text-slate-300">{meta.count} source-linked matches. Average fit <span className="text-cyan-300 font-medium">{meta.avg}</span>.</p>)}
            </CardContent>
          </Card>
          ...
          <Card className="mt-8 border-white/10 bg-white/[0.03]">
            <CardContent className="p-5">
              <p className="flex items-center gap-2 text-[11px] uppercase tracking-widest text-slate-400"><ShieldCheck className="h-3 w-3"/>Disclaimer</p>
              <p className="mt-2 text-sm text-slate-300">ScholarshipFit provides informational scholarship research only. It does not guarantee admission, scholarships, visas, or funding. Users apply directly through official provider websites. All deadline / funding numbers must be re-verified on the official source before applying.</p>
            </CardContent>
          </Card>

          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/onboarding"><Button size="lg" className="bg-orange-500 hover:bg-orange-400 text-white"><Rocket className="mr-2 h-5 w-5"/>Build my real report</Button></Link>
            <Link href="/advisor"><Button size="lg" variant="outline" className="border-white/15 bg-white/[0.03] text-slate-100 hover:bg-white/[0.06]">Ask Nova</Button></Link>
          </div>
        </div>
      </div>
      <Footer />
