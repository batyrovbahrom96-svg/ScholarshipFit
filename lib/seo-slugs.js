...
export const SEO_LANDING_PAGES = [
  ...
  ...[
    ...
    intro: (
      ...
      + `Below are the source-linked scholarships open to ${n.country} nationals — filtered from our hand-verified database of 800 premium programs and ranked so the most competitive, best-funded options appear first. `
