      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-3xl px-4 pt-14 pb-8 text-center relative">
          ...
          <p className="mt-4 text-white/70 max-w-2xl mx-auto">
            Paste your rejection letter. Nova extracts the real signals, names your profile gaps, and lines up <span className="text-white">verified alternatives</span> that actually fit you — from our source-linked database of 303.
          </p>
          ...
          <CardContent className="p-5">
            ...
            <div className="mt-3 grid md:grid-cols-3 gap-3 text-sm text-white/75">
              ...
              <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3">
                ...
                <div className="mt-1 text-xs text-white/60">Runs your profile through the 303-record DB and returns 3-5 scholarships that address the gaps — never invented.</div>
              </div>
            </div>
          </CardContent>
        </Card>
