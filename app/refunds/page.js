...
export const metadata = {
  ...
  description: 'ScholarshipFit\u2019s 14-day money-back guarantee and refund procedures.',
}
...
export default function RefundsPage() {
  return (
    <LegalPageShell
      title="Refund Policy"
      subtitle="Our 14-day money-back guarantee and how refunds work."
      updated="7 July 2026"
    >
      ...
      <ul>
        <li>Refund requests made <strong>more than 14 days</strong> after the initial payment.</li>
      ...
      <h2>4. Fair use</h2>
      <p>ScholarshipFit is a small team and we honour refunds in good faith. We reserve the right to decline refund requests that appear to be abusive (for example, repeated sign-up-and-refund cycles, or requests after significant paid feature consumption within the 14-day window). We will always explain our reasoning in writing.</p>
