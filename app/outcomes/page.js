        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          <Card className="border-white/10 bg-white/[0.03]">
            <CardContent className="p-5">
              ...
              <p className="mt-2 text-sm text-white/80">ScholarshipFit will never fabricate testimonials, invent universities, or pretend to have outcomes we can’t prove. If you spot a claim you can’t verify, please <a className="text-cyan-300 underline" href="/contact">tell us</a>.</p>
