  ...
  return (
    <div className="cosmos-bg min-h-screen">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-14">
        ...
        <p className="mt-2 text-slate-400">Plain-language, honest legal notes for ScholarshipFit.</p>
        ...
        <p className="mt-8 text-xs text-slate-500">Nothing on this site constitutes legal or financial advice. Individual results vary. ScholarshipFit does not guarantee similar outcomes.</p>
      </div>
      <Footer />
    </div>
  )
