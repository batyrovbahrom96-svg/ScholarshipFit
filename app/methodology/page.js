    ...
    <div className="dark-bg min-h-screen">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-14">
        ...
        <Section title="How matching works" icon={<Brain className="h-4 w-4"/>}>
          ...
          <ul className="mt-3 grid gap-1 text-white/80 [&>li]:list-disc [&>li]:ml-6">
        ...
        <Section title="What the AI can do" icon={<Check className="h-4 w-4"/>}>
          <ul className="grid gap-1 text-white/80 [&>li]:list-disc [&>li]:ml-6">
        ...
        <p className="mt-8 text-xs text-white/40">Individual results vary. ScholarshipFit does not guarantee similar outcomes.</p>
      </div>
      <Footer />
    </div>
  )
