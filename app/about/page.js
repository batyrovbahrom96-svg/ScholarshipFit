  ...
  return (
    <div className="cosmos-bg min-h-screen">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-14">
        ...
        <p className="mt-2 text-slate-400 max-w-2xl">ScholarshipFit is built for international students who are tired of scholarship blogs full of dead links, invented deadlines, and fake outcomes.</p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <Card className="border-white/10 bg-white/[0.03]"><CardContent className="p-6">
            ...
            <p className="mt-2 text-sm text-slate-300">We collect scholarships from official university and government portals, store the source URL alongside every record, and use Claude Sonnet 4.5 to explain fit — grounded in what the source actually says.</p>
          </CardContent></Card>
          <Card className="border-white/10 bg-white/[0.03]"><CardContent className="p-6">
            <p className="text-lg font-semibold text-white">What we don’t do</p>
            <p className="mt-2 text-sm text-slate-300">We don’t submit applications for you, we don’t promise scholarships, and we don’t invent deadlines. We’re a research accelerator — the final decision, verification, and application are always yours.</p>
          </CardContent></Card>
        </div>
        ...
        <Card className="mt-4 border-white/10 bg-white/[0.03]"><CardContent className="p-6">
          ...
          <ul className="mt-3 space-y-1 text-sm text-slate-300 [&>li]:list-disc [&>li]:ml-6">
