        ...
        <div className="container mx-auto max-w-3xl px-4 pt-16 pb-16 md:pt-20 md:pb-20">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  ...
                  <Link href="/database">
                    <Button className="btn-gold btn-pill font-semibold">
                      See our verified DB (800 hand-verified scholarships) <ArrowRight className="ml-2 h-4 w-4"/>
                    </Button>
                  </Link>
                </div>
              </CardContent>
          ...
          <div className="mt-10 rounded-2xl border border-white/10 bg-white/[0.02] p-5">
            ...
            <ul className="mt-3 grid gap-3 md:grid-cols-2 text-sm text-white/75">
              ...
              <li className="flex items-start gap-2"><ShieldCheck className="mt-0.5 h-4 w-4 text-emerald-400 shrink-0"/>Match against 800 hand-verified providers</li>
          ...
          <div className="mt-8 rounded-2xl border border-[#D4AF37]/25 bg-[#D4AF37]/[0.04] p-5 text-center">
            ...
            <p className="mt-2 text-sm text-white/70 max-w-xl mx-auto">
              ScholarshipFit ships you 800 hand-verified, source-linked scholarships ranked by fit — in under 60 seconds. No dead links. No aggregator spam.
            </p>
